...
def run_test_problem1a():
    ...
    # Test 3:
    expected = 0.342  # This is APPROXIMATELY the correct answer.
    answer = problem1a(7, 11)
    print()
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = 1.4797  # This is APPROXIMATELY the correct answer.
    answer = problem1a(12, 88)
    print()
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
